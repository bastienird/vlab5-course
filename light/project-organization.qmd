...
All project repositories used in this course are **pre-installed** in your environment.
...
Ready to run your first workflow? Jump to the next section [Running Rscripts in a loaded project](running-scripts-in-loaded-repo.qmd) about the running of some scripts in the Vlab infrastructure of BlueCloud 2026. 
